...
namespace QrAssignment.Application.Features.AppRole.Commands.Update
{
    ...
    public sealed class UpdateAppRoleCommandHandler : IRequestHandler<UpdateAppRoleCommand, Result>
    {
        ...
        public UpdateAppRoleCommandHandler(RoleManager<QrAssignment.Domain.Entity.App.AppRole> roleManager)
        {
            _roleManager = roleManager;
        }

        public async Task<Result> Handle(UpdateAppRoleCommand request, CancellationToken cancellationToken)
        {
